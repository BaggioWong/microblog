...
<body>
	<div id = "hidden-username"><?php echo $_SESSION['username'];?></div>
	<!-- wrapper -->
	<div id = "wrapper">
		<!-- header -->
		<div id = "header">
		...
		<div id = "main-content">
			...
			<div id = "left-column">
				...
				<?php show_tweets($_GET['username'], true); ?>
			...
			<div id = "right-column">
				...
				<div id = "personal-profile" class = "right-column-module">
					<div id = "profile-pic">
						<img src = <?php echo "./avatars/" . get_user_avatar($_GET['username']); ?> class = "user-pic-big"/>
					</div>

					<div id = "profile-meta">
						<p id = "display-name">
							<?php echo get_display_name($_GET['username']);?>
						</p>
						<br />
						<p id = "username">@<?php echo $_GET['username'];?></p>
							<button id = "follow-button">
							<?php 
								if (relationship_exists($_SESSION['username'], $_GET['username']))
									echo "解除关注";
								else
									echo "关注";
							?>
						...
						<table id = "tweets-meta">
							...
							<tr>
								<td id = "tweets-meta-tweets-count" class = "tweets-meta-data">
									<?php echo get_number_tweets($_GET['username']); ?>
								</td>
								<td id = "tweets-meta-following-count" class = "tweets-meta-data">
									<?php echo get_number_following($_GET['username']);?>
								</td>
								<td id = "tweets-meta-followers-count" class = "tweets-meta-data">
									<?php echo get_number_followers($_GET['username']);?>
								</td>
							</tr>
						</table>
					</div>
